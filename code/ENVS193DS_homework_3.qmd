...
```
This is the draft of the plot I will make and now I will make it into art.
...
I am showing the amount of time I bike based on the time of day. I wanted to make the image a visual representation of what the data meant. I did my work on digital drawing on my ipad. I created the work by making a plot as a background, so I could tie the visual to the data. I then worked on making the drawing a visual representation of the data. I used the color to show what time of day the data was. I used handle bars to show the range of the data. I used an image of a clock to show how much time had passed. (increments of 1 minute)
